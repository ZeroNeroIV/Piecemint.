  ...
  return (
    <div className="flex items-center justify-between gap-3">
      <div className="flex items-center gap-2.5 min-w-0">
        <PluginGlyph pluginId={pluginId} hasIcon={hasIcon} fallback={Plug} size={22} imgClassName="rounded-md" />
        <span id={`${pluginId}-label`} className="text-sm font-medium text-ink-black/80 min-w-0">
          {label}
          {locked && (
